...
# highest test score after a new score has been submitted. More specifically, we are looking for the kth highest score in the sorted list of all scores.
...
class KthLargest:
    ...
    def __init__(self, k: int, nums: List[int]):
        ...
        while len(self.min_heap) > k: # O(m = n-k)
